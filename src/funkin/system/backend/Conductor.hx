...
/**
	Originally written by SomeGuyWhoLovesCoding, Modified by @LeonGamerPS1
	https://github.com/SomeGuyWhoLovesCoding/FNF-PeoteView/blob/official/src/music/Conductor.hx
	Check out FNF-PeoteView! That engine is amazing!
